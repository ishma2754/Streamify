      ...
      <div className="flex-1">
        <div className="info">
          <div className="topInfo flex items-center gap-5">
            ...
            <h1 className="font-medium text-2xl text-[#f45b69]">{singleArtist.title}</h1>
          </div>
          <div className="details text-lg">
            {Object.entries(singleArtist.info).map((item) => (
              <div className="item my-8" key={item[0]}>
          ...
          <div className="latest mt-8">
            <h2 className="text-lg font-semibold text-[#f45b69]">Latest Album</h2>
            <p>
              {singleArtist.latest_album.title} (Released:{" "}
              {singleArtist.latest_album.release_date})
            </p>
            <h2 className="text-lg font-semibold mt-4 text-[#f45b69]">Latest Song</h2>
            <p>
          ...
          <div className="social-media mt-8">
            <h2 className="text-lg font-semibold text-[#f45b69]">Social Media Followers</h2>
              ...
              {Object.entries(singleArtist.social_media.followers).map(
                ([platform, count]) => (
                  <li key={platform} className="flex items-center mb-2">
                    ...
                    <span className="font-semibold">{platform}:</span> {count}
                  </li>
                )
              )}
            </ul>
        ...
        {singleArtist.chart && (
          <div className="chart mt-12 w-4/5 h-96 hidden md:block">
        ...
        <div className="relative">
          ...
          <ul className="flex flex-col pl-5">
            {singleArtist.activities &&
              singleArtist.activities.map((activity, index) => (
                <li key={activity.text} className="flex mb-4 relative">
                  ...
                  <div className="flex-1">
                    <div className="p-4 rounded-md bg-[#f45b6810]">
                      <p className="mb-1 text-white">{activity.text}</p>
